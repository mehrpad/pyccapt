...
def call_reflectron_correction_workflow(variables=None):
    ...
    output_stem = widgets.Text(value="", description="", layout=field_layout)
    ...
    def on_load(_):
        ...
        with out:
            ...
            try:
                ...
                output_directory.value = str(input_path.parent)
                output_stem.value = f"{input_path.stem}_corrected"
    ...
    workflow = widgets.VBox(
        [
            ...
            widgets.HBox([widgets.Label(value="Output directory:", layout=label_layout), output_directory]),
            widgets.HBox([widgets.Label(value="Output stem:", layout=label_layout), output_stem]),

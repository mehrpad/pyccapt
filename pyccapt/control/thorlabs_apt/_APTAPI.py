...
HWLIMSWITCH_MAKES_HOMEONLY = (
    4  # As per HWLIMSWITCH_MAKES except switch is ignored other than when homing (e.g. to support rotation stages).
)
HWLIMSWITCH_BREAKS_HOMEONLY = (
    5  # As per HWLIMSWITCH_BREAKS except switch is ignored other than when homing (e.g. to support rotation stages).
)
...
def set_ctypes_argtypes(lib):
    ...
    lib.GetHWInfo.argtypes = [c_long, c_char_p, c_long, c_char_p, c_long, c_char_p, c_long]
    ...
    lib.MOT_GetHomeParams.argtypes = [c_long, c_long_p, c_long_p, c_float_p, c_float_p]
    ...
    lib.MOT_SetStageAxisInfo.argtypes = [c_long, c_float, c_float, c_long, c_float]
    lib.MOT_SetStageAxisInfo.restype = c_long
    lib.MOT_GetStageAxisInfo.argtypes = [c_long, c_float_p, c_float_p, c_long_p, c_float_p]
    ...
    lib.MOT_GetPIDParams.argtypes = [c_long, c_long_p, c_long_p, c_long_p, c_long_p]
    ...
    lib.MOT_SetDCCurrentLoopParams.argtypes = [c_long, c_long, c_long, c_long, c_long, c_long]
    lib.MOT_SetDCCurrentLoopParams.restype = c_long
    lib.MOT_GetDCCurrentLoopParams.argtypes = [c_long, c_long_p, c_long_p, c_long_p, c_long_p, c_long_p]
    lib.MOT_GetDCCurrentLoopParams.restype = c_long
    lib.MOT_SetDCPositionLoopParams.argtypes = [c_long, c_long, c_long, c_long, c_long, c_long, c_long, c_long, c_long, c_long]
    lib.MOT_SetDCPositionLoopParams.restype = c_long
    lib.MOT_GetDCPositionLoopParams.argtypes = [
        c_long,
        c_long_p,
        c_long_p,
        c_long_p,
    ...
    lib.MOT_SetDCMotorOutputParams.argtypes = [c_long, c_float, c_float, c_float, c_float]
    lib.MOT_SetDCMotorOutputParams.restype = c_long
    lib.MOT_GetDCMotorOutputParams.argtypes = [c_long, c_float_p, c_float_p, c_float_p, c_float_p]
    ...
    lib.MOT_GetDCTrackSettleParams.argtypes = [c_long, c_long_p, c_long_p, c_long_p]
    ...
    lib.MOT_SetDCJoystickParams.argtypes = [c_long, c_float, c_float, c_float, c_float, c_long]
    lib.MOT_SetDCJoystickParams.restype = c_long
    lib.MOT_GetDCJoystickParams.argtypes = [c_long, c_float_p, c_float_p, c_float_p, c_float_p, c_long_p]
    lib.MOT_GetDCJoystickParams.restype = c_long
    lib.MOT_SetDCSettledCurrentLoopParams.argtypes = [c_long, c_long, c_long, c_long, c_long, c_long]
    lib.MOT_SetDCSettledCurrentLoopParams.restype = c_long
    lib.MOT_GetDCSettledCurrentLoopParams.argtypes = [c_long, c_long_p, c_long_p, c_long_p, c_long_p, c_long_p]
